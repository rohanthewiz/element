...
func TestHtmlElements(t *testing.T) {
	tests := []struct {
		...
		{name: "Html", function: func(b *Builder) Element { return b.Html() }, want: "<!DOCTYPE html.*></html>"},
		...
		{name: "Source", function: func(b *Builder) Element { return b.Source() }, want: "<source.*>"},
		{name: "Track", function: func(b *Builder) Element { return b.Track() }, want: "<track.*>"},
		{name: "Attr", function: func(b *Builder) Element { return b.Attr() }, want: "<attr.*></attr>"},
		{name: "Caption", function: func(b *Builder) Element { return b.Caption() }, want: "<caption.*></caption>"},
		{name: "Fieldset", function: func(b *Builder) Element { return b.Fieldset() }, want: "<fieldset.*></fieldset>"},
		{name: "Legend", function: func(b *Builder) Element { return b.Legend() }, want: "<legend.*></legend>"},
		{name: "Progress", function: func(b *Builder) Element { return b.Progress() }, want: "<progress.*></progress>"},
		{name: "Q", function: func(b *Builder) Element { return b.Q() }, want: "<q.*></q>"},
		{name: "Ruby", function: func(b *Builder) Element { return b.Ruby() }, want: "<ruby.*></ruby>"},
		{name: "Rt", function: func(b *Builder) Element { return b.Rt() }, want: "<rt.*></rt>"},
		{name: "Small", function: func(b *Builder) Element { return b.Small() }, want: "<small.*></small>"},
		{name: "Sub", function: func(b *Builder) Element { return b.Sub() }, want: "<sub.*></sub>"},
		{name: "Sup", function: func(b *Builder) Element { return b.Sup() }, want: "<sup.*></sup>"},
		{name: "TFoot", function: func(b *Builder) Element { return b.TFoot() }, want: "<tfoot.*></tfoot>"},
	}
